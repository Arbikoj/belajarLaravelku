...
<html lang="en">
    <head>
        ...
        <link
            ...
            rel="stylesheet"/>
        <!-- Define your gradient here - use online tools to find a gradient matching
        your branding-->
        <style>
            .gradient {
    ...
    <body
        ...
        <footer class="bg-white">
            ...
            <a
                ...
                class="text-gray-500">Background vector created by freepik - www.freepik.com</a>
        </footer>
        <!-- jQuery if you need it <script
