...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <nav id="header#" class="bg-white fixed w-full py-0 z-10 top-0 shadow">


        <div class="w-full container mx-auto flex flex-wrap items-center ml-0 mt-0 pt-0 pb-3 md:pb-0 shadow-2xl">

            <div class="w-40 pl-2 md:pl-0">
                <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold " href="#">
                    <i class="fa fa-user-circle-o text-pink-600 pr-3" aria-hidden="true"></i> Brucee
                </a>
            </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <a href="/dashboard" :active="request()->routeIs('/dashboard')" class="block py-1 md:py-3 pl-1 align-middle text-pink-600 no-underline hover:text-gray-900 border-b-2 {{ request()->is('/dashboard') ? 'active:border-orange-600' : '' }}  hover:border-orange-600">
                            <i class="fas fa-home fa-fw mr-3 text-pink-600"></i><span class="pb-1 md:pb-0 text-sm">Dashboard</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="/admin/post" :active="request()->routeIs('/admin/post') ? 'border-pink-500' : ' border-pink-500'" class="{{ request()->is('/admin/post') ? 'active: border-pink-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Posts</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="/admin/category" :active="request()->routeIs('/admin/category')" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-purple-500">
                            <i class="fa fa-server mr-3" aria-hidden="true"></i><span class="pb-1 md:pb-0 text-sm">Kategori</span>
                        </a>
                    </li>
                    <!-- <li class="mr-6 my-2 md:my-0">
